...
You need to know the probability of each source string being produced.
...
It might plausibly be argued that these scholars are speaking of \textbf{mutual information}, a measure of correlation.
They could be read as claiming that signals can bear mutual information without possessing semantic content.
...
Perhaps the collective misconstrual would not matter if not for the fact that the mutated form of {\sc Shannon's Warning} is false by the lights of communication theorists themselves.
...
This cashes out the pretheoretic usage of terms like `represent', `describe' and `specify' used by communication theorists themselves.
