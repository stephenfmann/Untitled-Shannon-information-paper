...
\noindent Symbols of a source lexicon consisting of Latin characters can be combined to produce messages that would be meaningful as strings of English, for example.
...
{\sc Shannon's Warning} tells us that those meanings do not play a part in the statement of or solution to the fundamental problem of communication.
...
It might plausibly be argued that these scholars are speaking of mutual information, a measure of correlation.
...
The mathematical tools of communication theory are indeed blind to the meaning of a source string, but interpretations of the theory require that signals are meaningful: the content of a signal is the identity of a source string.
...
The fewest binary symbols required is equal to a probabilistic measure of the process called its \textbf{entropy}.
...
\noindent The extent to which Cover \& Thomas's use of terms like ``describe'' and ``represent'' corresponds with philosophers' notions of semantic content has not to my knowledge been asked often.
% Obviously the authors cannot be interpreted as taking a stance on philosophical theories of content.
...
Teleosemantics puts theoretical legs under the intuition that signals represent source strings.
