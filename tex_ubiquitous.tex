...
In the other works cited in table \ref{tab:shannon}, one can find the following terms describing what I suggest is an indiscriminate hybrid of information theory and communication theory:
...
Before moving on, I recognise that the four kinds of projects characterised above -- the one I endorse, plus the three motivated by an assumption about information theory that I reject -- would be consistent with each other if only proponents agreed they meant different things by `semantic content'.
...
(The historical sciences sometimes use the word `signal' when referring to cues, but this is a difference in terminology and not a substantive dispute over definitions.)
...
(In fact Kelly's prose implies that the vehicle in question is a signal; on closer inspection, the theorem does not require it to be one.)
