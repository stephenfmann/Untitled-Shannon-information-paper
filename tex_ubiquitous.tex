...
It may be that the four kinds of projects characterised above -- the one I endorse, plus the three motivated by an assumption about information theory that I reject -- would be consistent with each other if only proponents agreed they meant different things by `semantic content'.
...
In \textit{The Hitchhiker's Guide to the Galaxy} Ford Prefect spends fifteen years writing an elaborately detailed encyclopedia entry about Earth, only for his editors to compress it to a single word: Harmless.
His protestations lead them to concede that they were over-zealous, so they allow an expansion: \textit{Mostly} harmless.
All of the concepts, tools, models and theorems devised by communication theorists over the past seventy years have been more or less compressed by philosophers into a single word: Information.
On reflection, they allow that the theory has provided a more specific concept: \textit{Mutual} information.
But that is all.
