...
\noindent This contradicts orthodoxy, but my point is that this particular orthodoxy, though tempting, is wrong-headed.
...
\noindent Channels, characterised by the conditional distribution of signals-after-noise given signals-before-noise $p(y|x)$, are general-purpose in the sense that the outcomes of any source can be encoded by the set of code symbols $X$.
