...
I reject the assumption that the only resources offered by Shannon's formal work to naturalist theories of representation are measures of correlational information.\footnote{\citet[$\S$5]{shea2018representation} discusses structural correspondence as a non-correlational source of semantic content, and suggests other possible sources \citep[p. 76 n. 1]{shea2018representation}. But he appears to share the premise that, among the tools devised by Shannon, measures of correlation are all that is relevant for naturalist representation.}
The view I proposed in the section on Shannon's Warning implies:
...
\noindent This contradicts orthodoxy, but my point is that this particular orthodoxy was never well-motivated.

Before moving on, I recognise that these four projects would be consistent with each other if only proponents agreed they meant different things by `semantic content'.
...
More recently he presses the point:
...
\par\hspace*{\fill}\citet[$\S$6.1]{dennett2017bacteria}, emphasis original
\end{myquote}

\noindent The present author has heard similar arguments from philosophers in conversation, moving from a claim about informational measures to the claim that communication theory cannot specify the contents of signals.
...
In terms of Dennett's analogy, the theory both measures the volume of a liquid and tells you which liquid is being measured.
