...
The goal is achieved by encoding the source string, which means converting it into a sequence of physical events (typically electrical pulses) that can be transmitted as a signal across a channel.
...
They achieve this goal by means of a signal whose form is determined by a \textbf{code}.
