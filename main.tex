...
One could of course assert that the tension is only apparent.
Philosophers are aiming for a theory of representation that would attribute content to paradigmatic representations (mental states, neurocognitive processes, linguistic utterances; perhaps also biological signals) while communications engineers are talking about the encoding of digital data.
...
Representationalists take the explanatory roles of representation in (for example) cognitive science to warrant realism about content, and design theories to 
account for those roles \citep{burge2010origins,shea2018representation}.
Prima facie, the representationalist should be trying to account for representational explanations in communication theory too.\footnote{Theories of representation in the philosophy of cognitive science typically assert conditions that a cognitive state must meet before it counts as a genuine representation \citep{shea2018representation,burge2010origins,piccinini2020nonnatural,desouzafilho2022dual}. Many such accounts would exclude the communication-theoretic signals discussed in this paper: they are more like simple sensory states than cognitive maps. My contention is that this rejection should take place, if it must, after these signals are recognised as candidates, just as sensory states are.}

Why then do philosophers habitually assert the opposite -- that communication theory ``ignores'', ``is mute about'', ``does not capture'', or ``offers no analysis of'' representational content?
It would help to know what exactly they are asserting.

\subsection{The target claim}
Clearly the philosophers are talking about the same thing.
Reference to `Shannon' in this context is reference to his theory: the mathematical theory of communication that spun off into the mathematical theory of information.
And clearly they are asserting some kind of negative claim about the connection between that theory and representational content.
The precise nature of that negative claim seems to differ from scholar to scholar; however (as will become clear) they are all influenced by the same lines of reasoning, and they all intend to assert a commonly accepted truism about communication theory.
It's worth coming up with a precisification of the claims, then it will at least be clear what I am denying when I deny it.

Philosophers typically use this kind of claim to justify giving theories of representation that don't involve communication theory.
Dretske [CITE] gives a new definition of what it is for an individual signal to carry information, a definition which isn't found in communication theory, and on which he bases a definition of semantic information [CITE].
...
All these authors are justifying giving accounts (or at least calling for accounts) of representational content that are not constrained by communication theory.
So this paper concerns the following claim:
...
This paper will argue that \tic{} is false.
...
The theory therefore rules out any metasemantic theory that fails to attribute the correct representational content to communication-theoretic signals (or which at least gives a revisionary or deflationary account of the content-talk of communication theorists).
The representationalist had better account for the content-talk of communications engineers, especially where that talk is doing demonstrable explanatory work. 
My sections \ref{sec:positive} and \ref{sec:warning} argue that content-talk is doing demonstrable explanatory and conceptual work in communication theory.
So a putative metasemantic theory had better account for it -- even if it just means being revisionary about such talk.
Of course, philosophers don't typically offer revisionist claims about content-talk in communication theory, because they don't typically realise there is such talk in the first place. 
...
It is this conflation that makes it appear \tic{} follows from \sw{}.

Perhaps the strongest argument for my position is that the mutated form of \sw{} is false by the lights of communication theorists themselves.
...
% I have relied on teleosemantics to give a flavour of a representationalist account of signals.
% This positive account is too liberal for some, who would reject teleosemantics on the grounds that it attributes representational content to states that are too simple to bear it.
% That's fine: my contention in this paper has been that communication-theoretic signals should be recognised as candidates for content attribution.
% All sides of the liberality debate should accept this.
