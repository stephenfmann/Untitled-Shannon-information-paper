...
Here's why: consider a nonnatural representation that represents in some way other than probability-raising; e.g. by bearing a structural resemblance to some world affair.
What could prevent there being a mathematical relationship between the accuracy of the representation, the successful behaviour it engenders, and the costs of constructing and maintaining it?
...
% No matter how genuine representations are defined, it is difficult to see how communication theory could fail to describe them.
% The mathematical core of the theory is about trading off effort for accuracy.
...
% 
% We are ignorant about whether communication theory could be extended to these more sophisticated systems because nobody has tried.
...
% Considerations of more sophisticated representations should motivate us to extend communication theory, not limit it.
