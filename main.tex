...
Although cognitive scientists apply mathematical tools derived from communication theory to study representations in the brain [CITES], these applications are in some important sense orthogonal to the determination of representational content.
...
\subsection{Liberal teleosemantics}
...
%%%
%%%
\subsection{Communication theory in cognitive science}
...
%%%%%%%%%%%%%
%%%%%%%%%%%%%
\section{More sophisticated representations}\label{sec:sophisticated}

Liberal teleosemantics identifies representational content with a particular kind of exploitable relation, but much of the discussion about cognitive representations focuses on more sophisticated features than that.
