...
For reasons of space, I will focus on Piccinini's recent account.
% I'll here just canvas two recent proposals, from Burge and Piccinini, in order to show that even if we accepted the distinctions they draw, we would not be warranted in concluding that communication theory cannot describe the representations they define.
%
% Burge focuses on perceptual constancies, holding that ...
...
%
% I admit there are aspects of Burge's genuine representation (e.g. perceptual constancies) that are not present in the central model.
%
...
My general response to this move is to point out that we have no real idea whether communication-theoretic models could be built of those more sophisticated relationships.
Nobody has tried.
Communications engineers have not tried because they are not typically interested in cognitive systems; philosophers have not tried because they have been told that communication theory is irrelevant to their endeavour.
Yet the few forays that have been made into cognitive science from this perspective have yielded positive results \citep{sims2016ratedistortion,martinez2019representations}; see section \ref{sec:positive}.
